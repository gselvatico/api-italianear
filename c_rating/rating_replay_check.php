...
if($num>0){
    ...
    if (count($records) === 0) {
        ...
        echo '<h2>Risposte del Contatto da autorizzare</h2>';
        ...
        foreach ($records as $record) {
            ...
            $cmdAuth="'autorizza_replay.php?c_rating_id=$parametro')";
            $cmdRej="'reject_replay.php?c_rating_id=$parametro')";
            echo '<tr>';
